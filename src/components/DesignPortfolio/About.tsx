...
export default function DesignAbout() {
  return (
    <section className="py-12 sm:py-16 md:py-20 px-4 relative bg-white overflow-hidden" style={{ backgroundImage: "url('/grid-bg.png')", backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center" }}>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            <div className="flex-1 order-1 lg:order-1">
              <motion.div
                ...
                viewport={{ once: true }}
                className="relative max-w-xs sm:max-w-sm mx-auto mb-6 lg:mb-8 lg:left-[-150px]"
              >
                <img src="/speech-bubble.png" alt="Speech Bubble" className="w-full h-auto" />
                <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-6 md:p-8 pt-6 sm:pt-8 md:pt-10">
                  <p className="text-black font-bold text-center text-xs sm:text-sm md:text-base leading-tight">
              ...
              >
                <img src="/wink.gif" alt="Wink" className="relative w-full h-auto lg:top-[-70px]" />
              </motion.div>
