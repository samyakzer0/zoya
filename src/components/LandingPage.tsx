...
export const LandingPage = () => {
  ...
  return (
    ...
    >
      ...
      <div className="text-center px-2 sm:px-4 lg:px-6 relative z-10">
        <motion.div
          animate={{
        ...
        >
          <motion.h1
            className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl drop-shadow-2xl"
            style={{
         ...
         <div className="flex items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
           ...
           <div
             className="relative w-16 sm:w-20 h-7 sm:h-8 bg-gray-700 rounded-full cursor-pointer"
             onClick={(e) => {
           ...
           >
             <motion.div
               animate={{
                 x: togglePosition === 'dev' ? 0 : togglePosition === 'center' ? (window.innerWidth < 640 ? 20 : 24) : (window.innerWidth < 640 ? 40 : 48),
               }}
