  ...
  return (
    <div className="fixed top-5 left-0 right-0 z-[9999]">
      <div className="flex justify-center pt-6">
        <motion.div
          className={cn(
            "flex items-center gap-4 bg-white/15 border border-white/18 backdrop-blur-lg py-3 px-3 rounded-full shadow-xl relative border-b border-white/18",
        ...
        >
          ...
          <img src="/zoya-logo1.png" alt="Zoya Logo" className="h-8 w-auto mr-4" />
          ...
          {items.map((item) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "relative cursor-pointer text-base font-semibold px-7 py-4 rounded-full transition-all duration-300",
